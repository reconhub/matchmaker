# Getting help with matchmaker

Thanks for using matchmaker. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/matchmaker/issues) to make sure the 
